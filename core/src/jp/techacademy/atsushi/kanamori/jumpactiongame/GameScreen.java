...
public class GameScreen extends ScreenAdapter {
    ...
    List<Enemy> mEnemys; // 課題で追加
    Sound sound = Gdx.audio.newSound(Gdx.files.internal("pyo2.mp3"));
    ...
    public GameScreen(JumpActionGame game) {
        ...
        mEnemys = new ArrayList<Enemy>(); // 課題で追加
        ...
        mPrefs = Gdx.app.getPreferences("jp.techacademy.atsushi.kanamori.jumpactiongame");
    ...
    public void render (float delta) {
        ...
        // Enemy
        for (int i = 0; i < mEnemys.size(); i++) // 課題で追加
    ...
    private void createStage() {
        ...
        while (y < WORLD_HEIGHT - 5) {
            ...
            /*Enemy enemy = new Enemy(enemyTexture, 0, 0, 134, 26);
            ...
            if (mRandom.nextFloat() > 0.6f) {              // 課題で追加
        ...
        // ゴールのUFOを配置
        mUfo = new Ufo(ufoTextue, 0, 0, 120, 74);
